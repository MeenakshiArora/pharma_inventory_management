...
class LoginWindow:
    def __init__(self, root):
        ...
        #frame1=self.root(root,borderwidth=2,relief="solid",pdx=20,pdy=20)
        ...
        self.img = Image.open(r"D:\ph1.jpeg")  # Use raw string to handle backslashes
        self.img = self.img.resize((60,60))  # Resize image to fit in the window
        self.logo = ImageTk.PhotoImage(self.img)
        self.logo_label = Label(self.frame, image=self.logo)
        self.logo_label.grid(row=0, column=0) ''' # Position the logo
        ...
        #______________________________Frame Generation__________________________________
...
class PharmacyManagementSystem:
    ...
    def setup_main_window(self):
        lbltitle = Label(self.root, text="PHARMACY MANAGEMENT SYSTEM", bd=10, relief=RIDGE, bg='white', fg='darkgreen', font=('Times New Roman', 30, "bold"))
        lbltitle.pack(side=TOP, fill=X, padx=2, pady=2)

        #DataFrame = Frame(self.root, bd=10, relief=RIDGE, padx=5)
        #DataFrame.place(x=0, y=80, width=1250, height=850)

        self.DataFrame2 = LabelFrame(self.root, bd=5, relief=RIDGE, padx=5, text="Available Modules", fg="darkred", font=('Times New Roman', 12, "bold"))
        self.DataFrame2.place(x=0, y=60, width=1270, height=150)
        self.DataFrame2.grid_rowconfigure(0, weight=1)
        self.DataFrame2.grid_rowconfigure(1, weight=1)
        self.DataFrame3 = LabelFrame(self.root, bd=5, relief=RIDGE, padx=5, text="Medicine Information", fg="darkred", font=('Times New Roman', 12, "bold"))
        self.DataFrame3.place(x=0, y=220, width=1270, height=450)
        self.add_buttons()
    ...
    def add_buttons(self):
        ...
        button1 = Button(self.DataFrame2, text="ADD ITEM", bg="#d7f1c9", fg="green",  font=("Times-Bold 12"), command=self.additem)
        button1.grid(row=0, column=0, padx=10, pady=5, sticky="ew")

        button2 = Button(self.DataFrame2, text="DELETE ITEM", bg="lightcoral", fg="white",  font=("Times-Bold 12"), command=self.deleteitem)
        button2.grid(row=1, column=0, padx=10, pady=5, sticky="ew")

        button3 = Button(self.DataFrame2, text="DISPLAY STOCK", bg="#d7f1c9", fg="green",  font=("Times-Bold 12"), command=self.displayall)
        button3.grid(row=1, column=1, padx=10, pady=5, sticky="ew")

        button4 = Button(self.DataFrame2, text="UPDATE ITEM", bg="#d7f1c9", fg="green",  font=("Times-Bold 12"), command=self.updateitem)
        button4.grid(row=0, column=1, padx=10, pady=5, sticky="ew")

        button5 = Button(self.DataFrame2, text="SEARCH ITEM", bg="#d7f1c9", fg="green",  font=("Times-Bold 12"), command=self.searchitem)
        button5.grid(row=0, column=2, padx=10, pady=5, sticky="ew")

        button6 = Button(self.DataFrame2, text="RESTOCKED ITEM", bg="lightcoral", fg="white",  font=("Times-Bold 12"), command=self.restockitem)
        button6.grid(row=1, column=2, padx=10, pady=5, sticky="ew")

        button7 = Button(self.DataFrame2, text="SHOW SORTED DATA", bg="#d7f1c9", fg="green",  font=("Times-Bold 12"), command=self.restockitem)
        button7.grid(row=0, column=3, padx=10, pady=5, sticky="ew")

        button9 = Button(self.DataFrame2, text="BILL GENERATION", bg="#d7f1c9", fg="darkgreen",  font=("Times-Bold 12"), command=self.billgenerate)
        button9.grid(row=1, column=3, padx=10, pady=5)

        # Log Out button
        button9 = Button(self.DataFrame2, text="LOG OUT", bg="lightcoral", fg="whit",  font=("Times-Bold 12"), command=self.exit_app)
        button9.grid(row=1, column=5, padx=10, pady=5, )
