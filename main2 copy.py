...
class PharmacyManagementSystem:
    ...
    def add_buttons(self):
        Label(self.DataFrame2, text= " Stock Management ", bg="#d7f1c9",fg="#21421e",width=20,font=("Arial",13,"bold")). grid(row=0,column=0,padx=30)
        Label(self.DataFrame2, text= " Access Database ", bg="#d7f1c9",fg="#21421e",width=20,font=("Arial",13,"bold")). grid(row=0,column=3,padx=30)
        Label(self.DataFrame2, text= " Handle Cash ", bg="#d7f1c9",fg="#21421e",width=20,font=("Arial",13,"bold")). grid(row=0,column=5,padx=30)
        button1 = Button(self.DataFrame2,text="ADD ITEM",bg="lightgrey",fg="green",width=20,font=("Times-Bold 11"),command=self.additem).grid(row=5,column=0,padx=30)
        button2 = Button(self.DataFrame2,text="DELETE ITEM",bg="lightgrey",fg="green",width=20,font=("Times-Bold 11"),command=self.deleteitem).grid(row=6,column=0,padx=30) 
        button3 = Button(self.DataFrame2,text="DISPLAY STOCK",bg="lightgrey",fg="green",width=20,font=("Times-Bold 11"), command=self.displayall).grid(row=7,column=0,padx=30)
        button4 = Button(self.DataFrame2,text="UPDATE ITEM",bg="lightgrey",fg="green",width=20,font=("Times-Bold 11"), command=self.updateitem).grid(row=5,column=3,padx=30)  
        button5 = Button(self.DataFrame2,text="SEARCH ITEM",bg="lightgrey",fg="green",width=20,font=("Times-Bold 11"), command=self.searchitem).grid(row=6,column=3,padx=30)  
        button6 = Button(self.DataFrame2,text="RESTOCKED ITEM",bg="lightgrey",fg="green",width=20,font=("Times-Bold 11"), command=self.restockitem).grid(row=7,column=3,padx=30) 
        button7 = Button(self.DataFrame2,text="ADD TRANSACTION ",bg="lightgrey",fg="green",width=20,font=("Times-Bold 11"), command=self.add_transaction).grid(row=5,column=5,padx=30)  
        button8 = Button(self.DataFrame2,text="BILLING",bg="lightgrey",fg="green",width=20,font=("Times-Bold 11"), command=self.restockitem).grid(row=6,column=5,padx=30) 
        button9 = Button(self.DataFrame2,text="LOG OUT",bg="lightgrey",fg="green",width=20,font=("Times-Bold 11"), command=self.searchitem).grid(row=7,column=5,padx=30)  
